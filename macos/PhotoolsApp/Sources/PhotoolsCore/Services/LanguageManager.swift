...
public final class LanguageManager: ObservableObject {
    ...
    private let chineseDictionary: [L10nKey: String] = [
        ...
        .baseDirectory: "基础工作目录",
        .flatMode: "扁平原地模式 (直接扫描并就地处理/保存)",
        .flatModeDesc: "忽略 Inbox/Processed 分层，直接原地扫描并规范化处理",
        .sourceDirectory: "照片源目录 (默认 Inbox)",
        .processedDirectory: "归档目标目录 (默认 Processed)",
        .performanceSection: "性能与格式",
        .rawExtensions: "可识别 RAW 扩展名 (逗号分隔)",
        .concurrencyWorkers: "并发处理协程数",
        .testBackupMode: "测试快照备份模式 (处理前自动备份至 Inbox_bak)",

        // Settings Plugins
        .pluginDefaults: "四大能力插件默认开关",
        .pluginGpxMatch: "GPX 轨迹匹配与 GPS 修正",
        .pluginInterpolate: "GPS 智能邻近推断与时间插值",
        .pluginGeocode: "离线高精逆地理编码地名写入",
        .pluginArchive: "拍摄日期规范归档与重命名",
        .pluginParams: "专属参数调优",
        .geosyncOffset: "geosync 时间偏移补偿 (如 0, +00:00:05)",
        .interpolateWindow: "智能推算时间窗口",
        .window15m: "15 分钟 (默认)",
        .window30m: "30 分钟",
        .window1h: "1 小时",
        .window2h: "2 小时",
        .window4h: "4 小时",
        .inPlaceRename: "原地重命名 (不建立 YYYY/MMDD/ 子目录)",
        .allowNoGps: "无 GPS 容错软降级 (跳过地名写入，安全直接归档)",
        ...
        .restoreStep2Desc: "从 Inbox_bak 备份目录完整还原原始测试照片至 Inbox。可选择是否同时清空 Processed 目录下的生成结果。",
    ...
    private let englishDictionary: [L10nKey: String] = [
        ...
        .moveToTrashDelete: "Move to Trash / Delete Asset Group",

        // Detail View & Inspector
        .noPhotoSelectedTitle: "No Photo Selected",
        .noPhotoSelectedSubtitle: "Click on any photo in the middle list to inspect full ExifTool shooting metadata.",
        .processedArchiveInfo: "Processed Directory Info",
        .processedArchiveCount: "Successfully Archived Photos",
        .gpxMatchOverview: "GPX Track Matching Overview",
        .gpxFilesCount: "Discovered Track Files",
        .gpxPipelineDesc: "The pipeline automatically ingests all GPX tracks and matches coordinates with sub-second accuracy.",
        .testRestoreMechTitle: "Snapshot & Restore Mechanism",
        .testRestoreMechDesc: "When test backup mode is enabled, photos in Inbox are backed up to Inbox_bak before processing for easy restoration.",
        .guideOverviewTitle: "Documentation & Guides",
        .guideOverviewDesc: "Read architecture specs and user manuals in the center panel.",
        .assetSummary: "Asset Unit Summary",
        .captureTime: "Capture Time",
        .primaryFile: "Primary File",
        .companionFiles: "Companion Files",
        .cameraAndExposure: "Camera & Exposure Parameters",
        ...
        .locationAndGeocoding: "Location & Geocoded Place",
        .gpsCoordinates: "GPS Coordinates",
        .latitudeLabel: "Latitude",
        .longitudeLabel: "Longitude",
        .altitudeLabel: "Altitude",
        .offlineGeocodeResult: "Offline Reverse Geocode Result",
        .instantLookup: "Instant Lookup Preview",
        .noGpsData: "No GPS Coordinate Data",
        .copyCoordinates: "Copy Coordinates",
        .previewGeocodeBtn: "Instant Geocode",
        .lookupInProgress: "Looking up...",
        .rawExifTagTree: "Raw ExifTool Tag Tree",
        .searchTagsPlaceholder: "Search EXIF / IPTC / XMP tags...",
        .pendingDiagnosticsSection: "Pending Triage & Diagnostics",
        .openLargeJpg: "Open Large (JPG)",
        .openOriginalImage: "Open Original",
        .locateInFinderHelp: "Locate and highlight photo in Finder",
        .shootingParamsTitle: "Shooting Parameters",
        .readingExif: "Reading shooting parameters...",
        .noExifRead: "No shooting parameters found",
        .gpsAndGeocodeTitle: "GPS Coordinates & Geocoded Place",
        .geocodedWrittenBadge: "Geocoded",
        .hasGpsNotGeocodedBadge: "Has GPS · Not Geocoded",
        .noGpsBadge: "No GPS Coordinates",
        .coordinatesLabel: "Coordinates:",
        .writtenLabel: "Written:",
        .previewPrefix: "Preview:",
        .geocodeNotice: "Notice: This normalized place name will be written to IPTC/XMP during pipeline execution.",
        .clickToPreviewGeocode: "Click for Instant Geocode Preview",
        .noGpsNotice: "No GPS coordinates in this photo yet. The pipeline will match GPX tracks or interpolate coordinates automatically.",
        .companionListTitle: "Companion Files List",
        .primaryDecisionSource: "Primary Source",
        .openThisFile: "Open File",
        .pendingReasonTitle: "Pending Diagnostic Reason",
        .allExifTagsTitle: "All ExifTool Tags",
        .filterTagsPlaceholder: "Filter tag name or value...",
        .noMatchingTags: "No matching tags",

        // Asset Types & Status
        .typeRawPairTitle: "RAW + JPG Pair",
        .typeRawOnlyTitle: "Standalone RAW File",
        .typeJpgOnlyTitle: "Standalone JPG File",
        .typeCompanionOnlyTitle: "Companion Files Only",
        .statusReadyTitle: "Ready to Process",
        .statusCompanionOnlyTitle: "Companion Files Only",
        .statusReadySuggestion: "Has primary file, ready for GPX match, GPS interpolation, geocoding and archive.",
        .statusCompanionOnlySuggestion: "Missing primary RAW/JPG file, skipped from pipeline processing.",

        // Geodata
        .geodataTitle: "Offline High-Precision Geodata Packs",
        .geodataSubtitle: "Powered by GeoNames & 3D KD-Tree spatial index for sub-millisecond 5-tier location lookup",
        .globalGeodataTitle: "Global Offline Geodata Packs",
        .globalGeodataDesc: "Built-in fine-grained China places & global continent indexes for offline reverse geocoding.",
        .geodataTerminalPolicyNotice: "Terminal Operation Protocol",
        .geodataTerminalPolicyDesc: "To ensure geodata accuracy and integrity validation, geodata packages must be explicitly installed via the Terminal (CLI).",
        .continentListTitle: "Continent Data Packs Status",
        .refreshStatus: "Refresh Status",
        .copyInstallAllCmd: "Copy Install All Command",
        .copyTerminalCmd: "Copy Command",
        .copiedToClipboard: "Copied to Clipboard",
        .checkingLocalGeodata: "Querying local geodata package status...",
        .noGeodataPacks: "No package info, click refresh button above",
        .uninstallCmdCopied: "Copy Uninstall Command",
        .installCmdCopied: "Copy Install Command",
        .continentName: "Continent / Region",
        .statusInstalled: "Installed",
        .statusNotInstalled: "Not Installed",
        .downloadInstall: "Install via CLI",
        .removeGeodata: "Remove via CLI",
        .testLookup: "Instant Coordinate Lookup Test",
        .testCoordinates: "Test Coordinates",
        .testResultTitle: "Geocoded Location Result",
        .queryTime: "Query Time",
        .geoEngineTitle: "Offline Reverse Geocoding Engine",
        .geoEngineDesc: "High-performance 3D KD-Tree spatial index for sub-millisecond reverse geocoding into Country, State, City, District & POI.",
        .latShort: "Lat",
        .lonShort: "Lon",
        .altShort: "Alt",
        .testBtn: "Test",
        .spatialAnalysisToggle: "Spatial Debug",
        .spatialAnalysisHelp: "Real-time 3D Cartesian coordinates, KD-Tree pruning traversal & Top-K topology logs",
        .presetsLabel: "Presets:",
        .topologicalResultTitle: "Nearest Neighbor Topological Result",
        .countryRegion: "Country / Region",
        .stateProvince: "State / Province",
        .cityPrefecture: "City / Prefecture",
        .districtCounty: "District / County",
        .scenicPoi: "Scenic POI",
        .formattedIptcTag: "IPTC/XMP Standard Tag",
        .nearestPointDist: "Nearest Point",
        .timezoneLabel: "Timezone",

        // Test & Restore
        .backupTitle: "Test Snapshots & Environment Restore",
        .backupSubtitle: "One-click snapshot backup of Inbox photos and instant restoration after testing",
        .testRestoreConsoleTitle: "Test Snapshot & Backup/Restore Console",
        .testRestoreConsoleDesc: "Manual full snapshot backup of Inbox photos before testing, with one-click restoration afterwards.",
        ...
        .backupStep1Title: "1. Create Full Snapshot Backup",
        .backupStep1Desc: "Back up all current Inbox photos into Inbox_bak before executing any tests or edits.",
        .backupNowBtn: "Backup Current Inbox Photos (Inbox → Inbox_bak)",
        .inboxEmptyWarning: "⚠️ Inbox directory is currently empty",
        .restoreStep2Title: "2. Restore Environment from Snapshot",
        .restoreStep2Desc: "Restore original photos from Inbox_bak to Inbox. Optionally wipe Processed outputs.",
        .restoreNowBtn: "Restore from Snapshot (Inbox_bak → Inbox)",
        .noBackupAvailableWarning: "⚠️ No Inbox_bak snapshot found",
        .createBackupBtn: "Create Full Snapshot Backup",
        .restoreBackupBtn: "Restore Inbox from Snapshot",
        .cleanProcessedToggle: "Clean Processed Directory on Restore",
        .backupSuccessMsg: "Snapshot backup created successfully",
        .restoreSuccessMsg: "Environment restored successfully from snapshot",
        .snapshotStatusTitle: "Snapshot Status",
        .backupExists: "Backup Available",
        .backupNotExists: "No Snapshot Available",
...
extension L10nKey {
    ...
    public var text: String {
        LanguageManager.shared.text(self)
    }
}
