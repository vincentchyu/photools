...
final class WorkspaceScannerTests: XCTestCase {
    func testScanGroupsAndSummaryWithPrimaryAssetModel() throws {
        ...
        XCTAssertEqual(summary.processedAssetGroups.count, 1)
        XCTAssertEqual(summary.processedAssetGroups.first?.baseName, "DSC_2025-10-06_1001")
        XCTAssertEqual(summary.processedAssetGroups.first?.primaryType, .rawOnly)
